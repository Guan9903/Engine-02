...
void OGLRenderer::UpdateShaderMatrices()	{
	if(currentShader) {
		...
		glUniformMatrix4fv(glGetUniformLocation(currentShader->GetProgram(), "lightMatrix")	  , 1,false, lightMatrix.values);
...
void OGLRenderer::SetShaderDirectionalLight(const Light& l)
{
	glUniform3fv(glGetUniformLocation(currentShader->GetProgram(), "lightPos"), 1, (float*)& l.GetPosition());
	glUniform4fv(glGetUniformLocation(currentShader->GetProgram(), "lightColour"), 1, (float*)& l.GetColour());
	glUniform3fv(glGetUniformLocation(currentShader->GetProgram(), "dirLight.direction"), 1, (float*)& l.GetDirection());
}

void OGLRenderer::SetShaderSpotLight(const Light& l)
{
	glUniform3fv(glGetUniformLocation(currentShader->GetProgram(), "spotLight.position"), 1, (float*)& l.GetPosition());
	glUniform4fv(glGetUniformLocation(currentShader->GetProgram(), "lightColour"), 1, (float*)& l.GetColour());
	glUniform3fv(glGetUniformLocation(currentShader->GetProgram(), "spotLight.direction"), 1, (float*)& l.GetDirection());
}
